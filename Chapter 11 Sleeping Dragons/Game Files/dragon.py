# -*- coding: utf-8 -*-
"""
Created on Sun Apr 23 15:34:45 2023
...
def check_for_dragon_collision(lair):
    ...
    x2_distance = hero2.x - lair["dragon"].x
    y2_distance = hero2.y - lair["dragon"].y
    distance2 = math.hypot(x2_distance, y2_distance)
    if (distance < ATTACK_DISTANCE or distance2 < ATTACK_DISTANCE):
...
def check_for_egg_collision(lair):
    ...
    if (hero.colliderect(lair["eggs"]) or hero2.colliderect(lair["eggs"])):
